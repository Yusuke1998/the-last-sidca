                        ...
                        <div class="block-content font-size-sm">
                            <form class="row" @keydown.enter.prevent="storeData">
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        <label>Sede</label>
                                        <v-select label="name" v-model="TclassroomData.headquarter" @input="getAreas" :options="list_headquarters"></v-select>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                                        <label>Area</label>
                                        <v-select label="name" :disabled="this.TclassroomData.headquarter.id == 0 || list_areas.length == 0" @input="getPrograms" v-model="TclassroomData.area" :options="list_areas"></v-select>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                                        <label>Programa</label>
                                        <v-select label="name" :disabled="this.TclassroomData.area.id == 0 || list_programs.length == 0" v-model="TclassroomData.program" :options="list_programs"></v-select>
                                    </div>
                                </div>
                                <!-- col-12 -->
                            </form>
...
export default {
	...
	methods:{
        ...
        getAreas()
        {
            let H = this.TclassroomData.headquarter
            if (H.id !== null) {
                this.list_areas = H.areas
            }
            if (this.list_areas.length == 0) {
                this.TclassroomData.area={
                    id:0,
                    name:null
                }
            }
